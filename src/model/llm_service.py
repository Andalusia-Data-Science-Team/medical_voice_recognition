...
from .utils.prompt import (
    get_refine_arabic_prompt_llama,
...
# Define Pydantic model for feature extraction output
...
class LLMService:
    ...
    def _get_prompt(prompt_type, model, text, conversational_mode=False):
        ...
        if prompt_type == "general_refine":
            return get_refine_arabic_prompt_llama(text)
        ...
        if prompt_type == "refine_arabic":
            ...
            return get_extraction_prompt_llama(text)
            ...
            if pydantic_model:
                ...
                if response.choices and response.choices[0].text.strip():
                    ...
                    try:
                        ...
                        return validated_output.dict()  # Return as dictionary
